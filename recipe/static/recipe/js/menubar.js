...
mealApp.addToMeal = function(t,id,name){
    ...
    if (mealApp.recipe_ids.includes(id)){
        ...
        $('#menu-recipes').append(
            `<li>
                <button id="removeFromMeal-`+id+`" class="btn btn-danger me-3" style="height:30px;width:40px;"onclick="mealApp.removeFromMeal(this,`+id+`)"> <img class="plus" style="width: 100%; height: 100%;" src=\'https://icons-for-free.com/iconfiles/png/512/x+icon-1320166903649367557.png'/> </button>
